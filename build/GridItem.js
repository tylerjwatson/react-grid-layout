...
var GridItem = function (_React$Component) {
  ...
  GridItem.prototype.mixinResizable = function mixinResizable(child, position) {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.cloneElement(child, { width: position.width, height: position.height })
    );
  };
  ...
  GridItem.prototype.render = function render() {
    ...
    var newChild = _react2.default.createElement('div', {
    ...
    }, _react2.default.cloneElement(child, { layout: { x: x, y: y, w: w, h: h }, size: { width: pos.width, height: pos.height } }));
